...
export const INITIAL_USERS: User[] = [
  { id: 1, name: 'Mamá',  avatar: '👩', role: 'admin',  points: 340, color: '#7C6AF7' },
  { id: 2, name: 'Papá',  avatar: '👨', role: 'admin',  points: 280, color: '#60A5FA' },
  { id: 3, name: 'Lucas', avatar: '👦', role: 'member', points: 420, color: '#4ADE80' },
  { id: 4, name: 'Sofía', avatar: '👧', role: 'member', points: 190, color: '#F472B6' },
];
